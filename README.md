...
它可运行于 Claude Code、Kiro 及其他兼容 Agent Skills 的 AI 助手，帮助设计者更高效地完成 BOS 场景下的需求分析、原型生成和设计评审。
...
- 分析 BOS 移动端需求，收敛符合业务场景的交互方案
- 生成可讨论、可体验的 BOS H5 交互原型
- 遵循 BOS 页面策略、组件规范和视觉语言完成设计表达
- 评审已有方案是否符合 BOS 场景、使用效率和设计规范

默认输出为**独立 HTML/CSS/JS 的交互式 H5 原型**；需要研发交付时，也可整理为 Taro/React 风格的实现方案。
