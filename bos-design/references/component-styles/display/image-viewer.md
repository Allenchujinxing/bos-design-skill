...
|---|---|
| Height | 48px |
| Background | `rgba(0, 0, 0, 0.4)` (40% 黑色半透明) |
| Position | 顶部，全宽 |
| 页码文字 | 16px / semibold 600 / `#fff` / line-height 24px / center |
| 页码格式 | `当前/总数`，如 `1/6` |
...
| Token | Value | Use |
|---|---|---|
| 预览背景 | `black` `#000000` | 全屏预览底色 |
| 导航栏背景 | `rgba(0,0,0,0.4)` | 多张模式顶部栏 |
| 页码文字 | `white1` `#ffffff` | 导航栏页码 |
