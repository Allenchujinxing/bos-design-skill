...
| Token | Value | Use |
|---|---|---|
| `Color/brand/branding-1` | `#0076ff` | Emphasis style icon (normal), input cursor |
| `Color/icon&text/gray1-text-icon-color-default` | `#111111` | Outlined style icon (normal), value text |
| `Color/icon&text/gray4-text-icon-color-disable` | `#bcc4cc` | Disabled icon, disabled text |
| `Color/neutral/gray5-component-border` | `#d3dae0` | Outlined style border (normal) |
| `Color/neutral/gray6-component-stroke` | `#e1e6eb` | Outlined style border (disabled) |
| `Color/neutral/gray8-bg-color-page` | `#f5f7fa` | Emphasis style value background (editable) |
