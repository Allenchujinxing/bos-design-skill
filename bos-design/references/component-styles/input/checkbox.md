...
| `Color/icon&text/gray4-text-icon-color-disable` | `#bcc4cc` | Disabled text and icon color |
| `Color/neutral/gray5-component-stroke` | `#d3dae0` | Unchecked icon border |
| `Color/neutral/gray6-component-stroke` | `#e1e6eb` | List item bottom border |
| `Color/neutral/gray8-bg-color-page` | `#f5f7fa` | Disabled unchecked icon fill |
| `Color/neutral/white1-bg-color-container` | `#ffffff` | Container background, unchecked icon fill |
